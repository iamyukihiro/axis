...
constexpr std::array<ParameterSpec, parameterCount> specs{{
    {ParameterId::input, "input", "Input", ParameterKind::floatValue, {-24.0f, 12.0f, 0.01f},
     0.0f, "dB"},
    {ParameterId::center, "center", "Mid", ParameterKind::floatValue, {-24.0f, 12.0f, 0.01f},
     0.0f, "dB"},
    {ParameterId::sideGain, "sideGain", "Side Gain", ParameterKind::floatValue,
     {-24.0f, 12.0f, 0.01f}, 0.0f, "dB"},
    {ParameterId::density, "density", "Side Density", ParameterKind::floatValue,
     {0.0f, 100.0f, 0.01f}, 0.0f, "%"},
    {ParameterId::width, "width", "Width", ParameterKind::floatValue, {0.0f, 200.0f, 0.01f},
     100.0f, "%"},
    {ParameterId::output, "output", "Output", ParameterKind::floatValue, {-24.0f, 12.0f, 0.01f},
     0.0f, "dB"},
